...
(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){let Asside=require('./modules/asside.js');let GoUp=require('./modules/go-up');let Footer=require('./modules/footer');let ScalePhoto=require('./modules/scale-photo');let Accordion=require('./modules/accordion');let Request=require('./modules/request');let Modal=require('./modules/modal-window');let Form=require('./modules/form');let Comment=require('./modules/comment');let ShowHideComments=require('./modules/show-hide-comments');let ChangeNav=require('./modules/change-nav');let ChoosePersons=require('./modules/choose-persons');let ShowTrailer=require('./modules/show-trailer');let GetFullMinScreen=require('./modules/get-full-min-screen');document.addEventListener('DOMContentLoaded',()=>{let asside=new Asside().init();let goUp=new GoUp().init();let footer=new Footer().init();let scalePhoto=new ScalePhoto().init();let accordion=new Accordion().init();let getRequest=new Request().getLast();let modal=new Modal();let form=new Form().init();let showHideComments=new ShowHideComments().init();let changeNav=new ChangeNav().init();let choosePersons=new ChoosePersons().init();let showTrailer=new ShowTrailer().init();let getFullMinScreen=new GetFullMinScreen().init();$("#accordion1").accordion({heightStyle:"100%",collapsible:true,active:'none'});$("#accordion2").accordion({heightStyle:"100%",collapsible:true,active:'none'});setTimeout(()=>{let comment=new Comment().init();},1000);});$(window).on('load',function(){let tree=new ClassyLeaves({leaves:50,maxY:5,multiplyOnClick:true,multiply:1,infinite:true,speed:3000,numImages:8,folder:'/assets/leaves/images/leaves/'});let body=document.querySelector('body');let nav=document.querySelector('nav');let mainSection=document.querySelector('.main-section');let foot=document.querySelector('footer');body.style.position='relative';nav.style.opacity='1';mainSection.style.opacity='0.98';foot.style.opacity='1';$('.loader').fadeOut(500);});},{"./modules/accordion":2,"./modules/asside.js":3,"./modules/change-nav":4,"./modules/choose-persons":5,"./modules/comment":6,"./modules/footer":7,"./modules/form":8,"./modules/get-full-min-screen":9,"./modules/go-up":10,"./modules/modal-window":12,"./modules/request":13,"./modules/scale-photo":14,"./modules/show-hide-comments":15,"./modules/show-trailer":16}],2:[function(require,module,exports){class Accordion{constructor(){this.accordion=document.querySelector(".accordion");this.accordionFlush=document.querySelector(".accordion-flush");}
...
module.exports=Comment;},{"./request":13}],7:[function(require,module,exports){class Footer{constructor(){this.footer=document.querySelector('.footer-licence');}
...
module.exports=GetFullMinScreen;},{}],10:[function(require,module,exports){class GoUp{constructor(){this.getUp=document.querySelector('.get-up');this.section=document.querySelector('.for-go-up');}
...
module.exports=ModalWindow;},{"./message":11,"./request":13}],13:[function(require,module,exports){class Request{constructor(){this.root=document.querySelector('.all-comments');this.showHideBtn=document.querySelector('.get-all-comments');}
...
module.exports=ScalePhoto;},{}],15:[function(require,module,exports){class ShowHideComments{constructor(){let Request=require('./request');this.request=new Request();this.showHideBtn=document.querySelector('.get-all-comments');this.allComments=document.querySelector('.all-comments');this.hide=this.allComments.dataset.hide;}
