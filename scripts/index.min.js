...
(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){let Asside=require('./modules/asside.js');let GoUp=require('./modules/go-up');let Footer=require('./modules/footer');let ScalePhoto=require('./modules/scale-photo');let Accordion=require('./modules/accordion');let Request=require('./modules/request');let Modal=require('./modules/modal-window');let Form=require('./modules/form');jQuery(window).on('load',function(){jQuery('.loader').fadeOut(300);});document.addEventListener('DOMContentLoaded',()=>{let tree=new ClassyLeaves({leaves:50,maxY:5,multiplyOnClick:true,multiply:1,infinite:true,speed:3000,numImages:8,folder:'/assets/leaves/images/leaves/'});let asside=new Asside().init();let goUp=new GoUp().init();let footer=new Footer().init();let scalePhoto=new ScalePhoto().init();let accordion=new Accordion().init();let getRequest=new Request().get();let modal=new Modal();let form=new Form().init();})},{"./modules/accordion":2,"./modules/asside.js":3,"./modules/footer":4,"./modules/form":5,"./modules/go-up":6,"./modules/modal-window":8,"./modules/request":9,"./modules/scale-photo":10}],2:[function(require,module,exports){class Accordion{constructor(){this.accordion=document.querySelector(".accordion");}
...
module.exports=Asside;},{}],4:[function(require,module,exports){class Footer{constructor(){this.footer=document.querySelector('.footer-licence');}
init(){let date=new Date();let year=date.toLocaleDateString().slice(6);this.footer.append(`© Made by Gup@lyuk 2021-${year}`);}}
module.exports=Footer;},{}],5:[function(require,module,exports){class Form{constructor(){}
...
module.exports=Form;},{}],6:[function(require,module,exports){class GoUp{constructor(){this.getUp=document.querySelector('.get-up');this.section=document.querySelector('.main-section');}
...
let icon=document.createElement('div');icon.classList.add('comment__icon');let name=document.createElement('div');name.classList.add('comment__name');name.append(elem.name);let text=document.createElement('div');text.classList.add('comment__text');let commentSpanStart=document.createElement('span')
commentSpanStart.append('«');let commentSpanSEnd=document.createElement('span')
commentSpanSEnd.append('»');text.append(elem.text);text.prepend(commentSpanStart);text.append(commentSpanSEnd);element.append(icon);element.append(name);element.append(text);return element;}}
