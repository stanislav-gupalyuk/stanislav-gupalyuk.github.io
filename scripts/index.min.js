...
(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){let Asside=require('./modules/asside.js');let GoUp=require('./modules/go-up');let Footer=require('./modules/footer');let ScalePhoto=require('./modules/scale-photo');let Accordion=require('./modules/accordion');let Request=require('./modules/request');let Modal=require('./modules/modal-window');let Form=require('./modules/form');let Comment=require('./modules/comment');jQuery(window).on('load',function(){jQuery('.loader').fadeOut(300);});document.addEventListener('DOMContentLoaded',()=>{let tree=new ClassyLeaves({leaves:50,maxY:5,multiplyOnClick:true,multiply:1,infinite:true,speed:3000,numImages:8,folder:'/assets/leaves/images/leaves/'});let asside=new Asside().init();let goUp=new GoUp().init();let footer=new Footer().init();let scalePhoto=new ScalePhoto().init();let accordion=new Accordion().init();let getRequest=new Request().get();let modal=new Modal();let form=new Form().init();setTimeout(()=>{let comment=new Comment().init();},1000)});},{"./modules/accordion":2,"./modules/asside.js":3,"./modules/comment":4,"./modules/footer":5,"./modules/form":6,"./modules/go-up":7,"./modules/modal-window":9,"./modules/request":10,"./modules/scale-photo":11}],2:[function(require,module,exports){class Accordion{constructor(){this.accordion=document.querySelector(".accordion");}
...
module.exports=GoUp;},{}],8:[function(require,module,exports){class Message{constructor(name,text){this.name=name;this.text=text;}}
...
sendMessage(){if(this.userNameInput.value.trim()===''||this.userTextInput.value.trim()===''){alert('Вы что-то не указали. Комментарий НЕ будет сохранен!');setTimeout(()=>{this.userNameInput.value='';this.userTextInput.value='';},500);return}else{let Message=require('./message');this.windowRoot.style.display='none';this.request.post(new Message(this.userNameInput.value,this.userTextInput.value))
