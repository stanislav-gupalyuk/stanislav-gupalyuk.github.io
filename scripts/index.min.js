...
this.post();})}
get(){$.ajax({url:'https://61fac1d387801d0017a2c252.mockapi.io/example/clients',method:'get',dataType:'json',success:(data)=>{setTimeout(()=>{this.getRating(data);},500)},error:err=>{alert(err.statusText);}});};post(){this.acceptBtn.disabled=true;class Pers{constructor(hero){this.hero=hero;}}
$.ajax({url:'https://61fac1d387801d0017a2c252.mockapi.io/example/clients',method:'post',dataType:'json',data:new Pers(this.currentHero),success:()=>{setTimeout(()=>{this.get();this.acceptBtn.disabled=false;},1000);},error:err=>{alert(err.statusText);}});}
