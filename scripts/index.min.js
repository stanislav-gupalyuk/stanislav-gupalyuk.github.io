...
init(){window.addEventListener('scroll',()=>{let currentPosition=this.section.getBoundingClientRect().y;if(currentPosition<=109){this.getUp.style.opacity='0.8';}
if(currentPosition>109){this.getUp.style.opacity='0';}
if(window.innerWidth<=660&&currentPosition<=85){this.getUp.style.opacity='0.8';}
