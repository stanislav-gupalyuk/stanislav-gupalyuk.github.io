...
init(){this.mainBtnNav.addEventListener('click',()=>{this.mainSection.style.display='block';this.personsSection.style.display='none';window.location.href='#';});this.personsBtnNav.addEventListener('click',()=>{removeClass(this.personTitle);displayNone(this.personInfo)
