...
init(){this.mainBtnNav.addEventListener('click',()=>{this.mainSection.style.display='block';this.layoutSection.style.display='none';});this.layoutBtnNav.addEventListener('click',()=>{this.layoutSection.style.display='block';this.mainSection.style.display='none';})
this.mainBtnAsside.addEventListener('click',()=>{this.mainSection.style.display='block';this.layoutSection.style.display='none';this.asside.hide();});this.layoutBtnAsside.addEventListener('click',()=>{this.layoutSection.style.display='block';this.mainSection.style.display='none';this.asside.hide();})}}
...
if(window.innerWidth<=660&&currentPosition>=85){this.getUp.style.opacity='0';}});}}
