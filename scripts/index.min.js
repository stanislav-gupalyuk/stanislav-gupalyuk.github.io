...
init(){this.mainBtnNav.addEventListener('click',()=>{this.mainSection.style.display='block';window.location.href='#';});this.mainBtnAsside.addEventListener('click',()=>{this.mainSection.style.display='block';this.asside.hide();window.location.href='#';});}}
